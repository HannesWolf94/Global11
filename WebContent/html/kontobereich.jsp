...
<html lang="de">
	...
	<body>
		...
		<form method=post action="${pageContext.request.contextPath}/KontoAendern">
			<div>
			...
			<div>
				<label for="city"> PLZ und Ort: </label> <br> 
		...
		<form id="password" action="${pageContext.request.contextPath}/Password" method="post">
			<div>
				<label for="pw"> altes Passwort: </label> <br> 
				<input type="password" name="oldPassword" id="pw" size="15" required>
			</div>
			<div>
				<label for="newPassword"> neues Passwort: </label> <br> 
				<input type="password" name="newPassword" id="newPassword" size="15" required>
			</div>
			<div>
				<label for="passwordConfirmation"> Passwort bestätigen: </label><br>
				<input type="password" id="passwordConfirmation" name="passwordConfirmation" size="15" required>
			</div>
			<div>
		...
		<form method="post" action="${pageContext.request.contextPath}/AccountLoeschen">
			<fieldset>
				<div>
					<label for="email"> Konto löschen:</label> 
					<input type="text" name="email" id="email" placeholder="Bitte Ihre Email eingeben" required>
				</div>
				<div>
